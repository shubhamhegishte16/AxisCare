      ...
      <header className="bg-white py-4 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-8 flex justify-between items-center">
          <div className="flex items-center gap-2 text-2xl font-bold">
            ...
            <span className="bg-gradient-to-r from-[#00B9D6] to-[#004AC6] bg-clip-text text-transparent">AxisCare</span>
          </div>
          ...
          <nav className="hidden md:flex gap-8">
            ...
            <a href="#" className="font-medium text-[0.95rem] transition-colors hover:text-primary">Contact</a>
          </nav>
          ...
          <div className="max-w-7xl mx-auto px-8 flex flex-col lg:flex-row items-center justify-between gap-16">
            <div className="flex-1 text-white z-10">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-4">
                Your Health, Our Global Priority.
              </h1>
              <p className="text-white/90 text-lg mb-8 max-w-lg">
                Leading-edge hospital management designed for modern clinical excellence. We unify patient care, administrative efficiency, and advanced medical expertise.
              </p>
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-white p-4 md:p-6 rounded-2xl flex items-center gap-4 shadow-xl text-slate-800">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-slate-500">Patients Served</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:-translate-y-1 transition-transform duration-300">
                ...
                <a href="#" className="text-primary font-semibold text-sm flex items-center gap-2 hover:gap-3 transition-all">Meet the team &rarr;</a>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:-translate-y-1 transition-transform duration-300">
                ...
                <a href="#" className="text-primary font-semibold text-sm flex items-center gap-2 hover:gap-3 transition-all">Response times &rarr;</a>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:-translate-y-1 transition-transform duration-300">
                ...
                <a href="#" className="text-primary font-semibold text-sm flex items-center gap-2 hover:gap-3 transition-all">Latest updates &rarr;</a>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-slate-800 relative inline-block">
                ...
                <span className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-16 h-1 bg-primary"></span>
              </h2>
            </div>
              ...
              <div className="flex-1 flex flex-col gap-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-[0.95rem]">Utilizing AI-driven tools to identify health issues with unprecedented clinical accuracy.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-[0.95rem]">Real-time health tracking systems ensuring proactive intervention for chronic conditions.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-[0.95rem]">Cloud-native infrastructure protecting patient data with military-grade encryption.</p>
                  </div>
                </div>
              </div>
              
              <div className="flex-1">
                <img src="/hospital area.jpg" alt="Modern hospital area" className="w-full rounded-2xl shadow-xl object-cover" />
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-[#0b5fb4] text-white pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-white/80 text-[0.9rem] mb-6 max-w-xs">
                Revolutionizing healthcare management through professional excellence and clinical precision.
              </p>
              <div className="flex gap-4">
                ...
                <a href="#" className="bg-white/10 w-9 h-9 rounded-full flex items-center justify-center hover:bg-primary transition-colors"><Share2 size={18} /></a>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              ...
              <ul className="flex flex-col gap-3">
                ...
                <li><a href="#" className="text-white/80 text-[0.9rem] hover:text-white transition-colors">Career Opportunities</a></li>
              </ul>
            </div>
            ...
            <div className="lg:col-span-1">
              ...
              <ul className="flex flex-col gap-3">
                ...
                <li><a href="#" className="text-white/80 text-[0.9rem] hover:text-white transition-colors">Insurance Partners</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-white/10 pt-6 text-center text-white/60 text-sm">
            &copy; {new Date().getFullYear()} AxisCare Hospital Management. All rights reserved. Professional healthcare solutions for a global future.
          </div>
        </div>
      </footer>
    </div>
